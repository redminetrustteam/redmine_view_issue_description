...
This plugin also adds two new permissions that hide and disable the "activities" menu, per project and/or global.
...
4. Click check box of view_issue_description column on the bottom of the page [Issue tracking]
