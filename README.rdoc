...
And it adds a "not equal to" filter on "start_date" and "end_date"
...
The plugin has been published on the https://www.redmine.org/plugins page, but please be aware of the alpha-stage.
