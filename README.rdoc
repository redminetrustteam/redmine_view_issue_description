...
This plugin is currently in alpha-stage and has been written as a first Ruby poject. All comments, suggestions, corrections and help is very welcome.
The plugin will be published on the https://www.redmine.org/plugins page, but please be aware of the alpha-stage.
