...
2. Hack and add this line before the last "end" and without quotes to "app/views/issues/show.api.rsb": "call_hook(:view_issues_show_api, {:root_api => api, :issue => @issue})"
2. Restart REDMINE
...
5. Click check box of view_issue_description and view_activities that is in [Project]
6. API: https://site.url/issues/<issue_id_here>.json?include=journal_messages,journals
